  ...
  test("POST /users", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastModifiedDate: CREATE_RESULT.lastModifiedDate.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          lastModifiedDate: FIND_MANY_RESULT[0].lastModifiedDate.toISOString(),
        },
      ]);
  });
  ...
  test("GET /users/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastModifiedDate: FIND_ONE_RESULT.lastModifiedDate.toISOString(),
      });
  });
