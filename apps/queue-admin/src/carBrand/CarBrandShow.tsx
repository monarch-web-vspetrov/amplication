...
import { CARBRAND_TITLE_FIELD } from "./CarBrandTitle";
import { CARTYPE_TITLE_FIELD } from "../carType/CarTypeTitle";

export const CarBrandShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
        ...
        <ReferenceManyField reference="Car" target="carBrandId" label="Cars">
