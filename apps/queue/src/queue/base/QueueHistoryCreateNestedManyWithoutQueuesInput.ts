...
@InputType()
class QueueHistoryCreateNestedManyWithoutQueuesInput {
...
export { QueueHistoryCreateNestedManyWithoutQueuesInput as QueueHistoryCreateNestedManyWithoutQueuesInput };
