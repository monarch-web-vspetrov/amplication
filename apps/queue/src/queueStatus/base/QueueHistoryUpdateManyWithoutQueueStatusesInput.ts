...
@InputType()
class QueueHistoryUpdateManyWithoutQueueStatusesInput {
...
export { QueueHistoryUpdateManyWithoutQueueStatusesInput as QueueHistoryUpdateManyWithoutQueueStatusesInput };
